...
def export_to_csv(results: list, input_file: str):
    ...
    with open(main_csv, 'w', newline='') as f:
        ...
        # Header
        writer.writerow([
            'GPU', 'Workload', 'Max_Freq_MHz', 'Fastest_Freq_MHz',
            'EDP_Optimal_Freq_MHz', 'EDP_Energy_Savings_Percent', 'EDP_Performance_vs_Max_Percent', 'EDP_Improvement_Percent',
            'ED2P_Optimal_Freq_MHz', 'ED2P_Energy_Savings_Percent', 'ED2P_Performance_vs_Max_Percent', 'ED2P_Improvement_Percent',
            'Is_Max_Freq_Fastest', 'Runs_Averaged'
        ])
    ...
    with open(workload_edp_csv, 'w', newline='') as f:
        ...
        # Header
        writer.writerow(['Workload', 'A100_EDP_Energy_Savings', 'H100_EDP_Energy_Savings', 'V100_EDP_Energy_Savings', 'Best_GPU_EDP', 'Best_EDP_Savings'])
    ...
    with open(workload_ed2p_csv, 'w', newline='') as f:
        ...
        # Header
        writer.writerow(['Workload', 'A100_ED2P_Energy_Savings', 'H100_ED2P_Energy_Savings', 'V100_ED2P_Energy_Savings', 'Best_GPU_ED2P', 'Best_ED2P_Savings'])
    ...
    with open(freq_csv, 'w', newline='') as f:
        ...
        # Header
        writer.writerow(['GPU', 'Workload', 'Max_Freq_MHz', 'EDP_Optimal_Freq_MHz', 'EDP_Reduction_MHz', 'EDP_Reduction_Percent',
                        'ED2P_Optimal_Freq_MHz', 'ED2P_Reduction_MHz', 'ED2P_Reduction_Percent', 'Fastest_Freq_MHz'])
    ...
    with open(gpu_edp_csv, 'w', newline='') as f:
        ...
        # Header
        writer.writerow(['GPU', 'EDP_Avg_Energy_Savings', 'EDP_Configurations_Faster_Than_Max', 'Total_Configurations', 'EDP_Faster_Percentage'])
    ...
    with open(gpu_ed2p_csv, 'w', newline='') as f:
        ...
        # Header
        writer.writerow(['GPU', 'ED2P_Avg_Energy_Savings', 'ED2P_Configurations_Faster_Than_Max', 'Total_Configurations', 'ED2P_Faster_Percentage'])

...
def demonstrate_frequency_validation(gpu_type: str):
    ...
    try:
        ...
        test_configs = [
            ...
            (1500, memory_freq),
            (2000, memory_freq),
            (1200, 1000)  # Wrong memory frequency
        ]
...
def demonstrate_gpu_comparison():
    ...
    for gpu in ['V100', 'A100', 'H100']:
        if gpu in comparison and 'error' not in comparison[gpu]:
            ...
            print(f"  {gpu}: {specs['cuda_cores']} CUDA cores, "
...
def main():
    ...
    parser.add_argument('--gpu-type', choices=['V100', 'A100', 'H100'], 
                       default='V100', help='GPU type to demonstrate')
    parser.add_argument('--compare-all', action='store_true',
                       help='Show comparison of all GPU types')
    parser.add_argument('--integration', action='store_true',
                       help='Show framework integration examples')

...
def get_module_info():
    ...
    return {
        ...
        'core_components': [
            'EDPCalculator', 'EnergyProfiler', 'PerformanceProfiler', 'OptimizationAnalyzer'
        ],
        ...
        'example_usage': {
            ...
            'feature_selection': 'df_opt, analysis = create_optimized_feature_set(df, gpu_type="V100")' if FEATURE_SELECTION_AVAILABLE else 'Not available'
        }
    }

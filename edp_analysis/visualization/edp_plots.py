...
class EDPPlotter:
    ...
    def plot_energy_delay_tradeoff(
        self,
        df: pd.DataFrame,
        energy_col: str = "energy",
        time_col: str = "execution_time",
    ...
    def plot_frequency_sweep_analysis(
        self,
        df: pd.DataFrame,
        frequency_col: str = "frequency",
        energy_col: str = "energy",
...
def create_optimization_summary_plot(
    ...
    def plot_feature_importance_for_edp(
        self,
    ...
    def plot_fgcs_optimization_results(
        self,
    ...
    def create_comprehensive_edp_dashboard(
        self,

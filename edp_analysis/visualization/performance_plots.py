...
class PerformancePlotter:
    ...
    def plot_execution_time_vs_frequency(self,
                                       df: pd.DataFrame,
        ...
        if optimal_freq is not None:
            ...
            if not optimal_row.empty:
                ...
                ax.plot(optimal_freq, optimal_time, 'ro', markersize=10, 
        ...
        ax.annotate(f'Fastest: {min_time:.2f}s', 
                   xy=(min_freq, min_time), xytext=(10, 10),
                   textcoords='offset points', ha='left',
                   bbox=dict(boxstyle='round,pad=0.3', facecolor='green', alpha=0.3),
                   arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=0'))
        
        ax.annotate(f'Slowest: {max_time:.2f}s', 
                   xy=(max_freq, max_time), xytext=(10, -10),
                   textcoords='offset points', ha='left',
    ...
    def plot_performance_scaling(self,
        ...
        ax1.plot(df_work[frequency_col], df_work['speedup'], 'b-o', 
                linewidth=2, markersize=6, label='Actual Speedup')
        ax1.plot(df_work[frequency_col], df_work['ideal_speedup'], 'r--', 
        ...
        ax2.plot(df_work[frequency_col], df_work['efficiency'], 'g-o', 
                linewidth=2, markersize=6, label='Scaling Efficiency')
    ...
    def plot_throughput_analysis(self,
        ...
        ax1.plot(df_work[frequency_col], df_work['throughput'], 'b-o', 
        ...
        ax1.plot(max_freq, max_throughput, 'ro', markersize=10, 
                label=f'Max Throughput ({max_freq} MHz)')
        ax1.legend()
        
        # Plot 2: Throughput vs execution time scatter
        scatter = ax2.scatter(df_work[time_col], df_work['throughput'], 
    ...
    def plot_multi_application_performance(self,
        ...
        for i, (app_name, df) in enumerate(data_dict.items()):
            ...
            ax2.plot(df[frequency_col], efficiency, 'o-', 
                    color=colors[i], linewidth=2, markersize=6, label=app_name)
    ...
    def plot_performance_model_validation(self,
        ...
        ax3.plot(actual_df[frequency_col], actual_df[actual_time_col], 
                'b-o', linewidth=2, markersize=6, label='Actual')
        ax3.plot(predicted_df[frequency_col], predicted_df[predicted_time_col], 
    ...
    def plot_fgcs_performance_validation(self,
                                       df: pd.DataFrame,
    ...
    def plot_throughput_analysis(self,
        ...
        if throughput_col in df.columns:
            scatter = ax3.scatter(df[latency_col], df[throughput_col], 

...
class PowerPlotter:
    ...
    def plot_power_vs_frequency(
        ...
        ax.annotate(
            f"Min: {min_power:.1f}W",
            xy=(min_freq, min_power),
            xytext=(10, 10),
    ...
    def plot_multi_application_power(
        self,
    ...
    def plot_power_model_validation(
        self,
    ...
    def plot_fgcs_power_validation(
        self,
        df: pd.DataFrame,
    ...
    def plot_power_breakdown_analysis(
        self,
        df: pd.DataFrame,
        frequency_col: str = "frequency",
        power_col: str = "power",
    ...
    def plot_energy_efficiency_analysis(
        ...
        if power_efficiency is not None and energy_per_op is not None:
            ...
            if np.any(pareto_mask):
                ...
                ax4.plot(
                    pareto_power_eff[sorted_indices],
                    pareto_energy_per_op[sorted_indices],
                    "r-",
                    linewidth=2,
                    alpha=0.7,

...
class TestConvenienceFunctions(unittest.TestCase):
    ...
    def test_gpu_summary(self):
        ...
        for gpu_type in get_supported_gpus():
            with self.subTest(gpu_type=gpu_type):
                ...
                required_fields = [
                    'gpu_type', 'architecture', 'frequency_range',
                    'frequency_count', 'memory_size', 'memory_bandwidth',
                    'sm_count', 'cuda_cores', 'tensor_cores',
                    'compute_capability', 'tdp', 'supported_frequencies'
                ]
    ...
    def test_module_info(self):
        ...
        # Check required fields
        required_fields = [
            'version', 'description', 'implemented_modules',
            'planned_modules', 'supported_gpus', 'total_gpu_specifications',
            'example_usage'
        ]

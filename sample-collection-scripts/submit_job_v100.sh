...
# LAUNCH_ARGS="--gpu-type V100 --profiling-mode baseline --app-name ViT --app-executable ../app-vision-transformer/ViTViaHF.py --app-params '--benchmark --num-images 5 --model google/vit-base-patch16-224' --num-runs 3"
...
# LAUNCH_ARGS="--gpu-type V100 --profiling-mode custom --custom-frequencies '510,960,1380' --app-name ViT --app-executable ../app-vision-transformer/ViTViaHF.py --app-params '--benchmark --num-images 5 --model google/vit-base-patch16-224' --num-runs 5 --sleep-interval 2"

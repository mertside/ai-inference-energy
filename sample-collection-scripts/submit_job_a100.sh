...
# LAUNCH_ARGS="--gpu-type A100 --profiling-mode dvfs --app-name StableDiffusion --app-executable ../app-stable-diffusion/StableDiffusionViaHF.py --app-params '--prompt \"a photograph of an astronaut riding a horse\" --steps 50 --no-save-images --job-id ${SLURM_JOB_ID} --log-level INFO' --num-runs 5 --sleep-interval 2"
...
# LAUNCH_ARGS="--gpu-type A100 --profiling-mode dvfs --app-name LLaMA --app-executable ../app-llama/LlamaViaHF.py --app-params '--benchmark --num-generations 3 --quiet --metrics' --num-runs 5 --sleep-interval 2"

# 17. 🎤 WHISPER DVFS - Complete frequency analysis for speech recognition (~4-6 hours, change --time to 08:00:00)
# LAUNCH_ARGS="--gpu-type A100 --profiling-mode dvfs --app-name Whisper --app-executable ../app-whisper/WhisperViaHF.py --app-params '--benchmark --model base --num-samples 10 --quiet' --num-runs 5 --sleep-interval 2 --sampling-interval 25"
# 17b. 🎤 WHISPER LARGE MODEL - Longer inference times with large model for better utilization capture
# LAUNCH_ARGS="--gpu-type A100 --profiling-mode dvfs --app-name Whisper --app-executable ../app-whisper/WhisperViaHF.py --app-params '--benchmark --model large --num-samples 5 --quiet' --num-runs 5 --sleep-interval 2 --sampling-interval 25"

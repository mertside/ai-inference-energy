...
class FGCSPowerModelingFramework:
    ...
    def __init__(self, model_types: Optional[List[str]] = None,
        ...
        self.frequency_configs = {            'V100': [1380, 1372, 1365, 1357, 1350, 1342, 1335, 1327, 1320, 1312, 1305, 1297, 1290, 1282, 1275, 1267,
                     ...
                     570, 562, 555, 547, 540, 532, 525, 517, 510],  # 117 frequencies ≥510 MHz
            ...
            'H100': [1785, 1770, 1755, 1740, 1725, 1710, 1695, 1680, 1665, 1650,
                     ...
                     585, 570, 555, 540, 525, 510]  # 86 frequencies ≥510 MHz
        }

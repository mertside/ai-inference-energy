...
class FGCSPowerModelingFramework:
    ...
    def __init__(self, model_types: Optional[List[str]] = None,
        ...
        # GPU-specific frequency configurations
        self.frequency_configs = {
            'V100': list(range(405, 1381, 7)),  # V100 frequency range
            'A100': [210, 420, 630, 840, 1065, 1290, 1410],  # A100 frequencies
            'H100': list(range(210, 1981, 17))  # H100 estimated range
        }

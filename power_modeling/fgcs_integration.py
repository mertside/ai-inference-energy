...
from edp_analysis.edp_calculator import DVFSOptimizationPipeline, FGCSEDPOptimizer
...
class FGCSPowerModelingFramework:
    ...
    def __init__(self, model_types: Optional[List[str]] = None, gpu_type: str = "V100"):
        """

...
# GPU frequency configurations for different architectures (updated with actual hardware data ≥510 MHz)
GPU_FREQUENCY_CONFIGS = {
    'V100': [1380, 1372, 1365, 1357, 1350, 1342, 1335, 1327, 1320, 1312, 1305, 1297, 1290, 1282, 1275, 1267, 
             ...
             570, 562, 555, 547, 540, 532, 525, 517, 510],  # 66 frequencies ≥510 MHz

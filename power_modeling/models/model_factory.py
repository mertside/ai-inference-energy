...
# Import FGCS models
from .fgcs_models import FGCSPowerModel, PolynomialPowerModel, PerformanceMetricsCalculator
from .ensemble_models import EnhancedRandomForestModel, XGBoostPowerModel, ModelEvaluator
...
class FGCSModelFactory:
    ...
    @staticmethod
    def create_enhanced_random_forest(optimization_method: str = 'random', 
                                    n_iter: int = 100) -> EnhancedRandomForestModel:
        """
...
class ModelPipeline:
    ...
    def __init__(self, model_types: Optional[List[str]] = None):
        ...
        self.model_types = model_types or [
            'fgcs_original', 'polynomial_deg2', 'random_forest_enhanced', 'linear'
        ]
        self.models = {}
    ...
    def predict_power_across_frequencies(self, fp_activity: float, dram_activity: float,
                                       frequencies: List[int], model_name: str = None) -> pd.DataFrame:
        """
